...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20221206191018_SaltLength")]
    partial class SaltLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.VProductModelCatalogDescription", b =>
                {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.CustomerAddress", b =>
                {
                    b.HasOne("OnlineShop.Domain.Models.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("OnlineShop.Domain.Customers.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("OnlineShop.Domain.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("OnlineShop.Domain.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("OnlineShop.Domain.Models.Address", "ShipToAddress")
